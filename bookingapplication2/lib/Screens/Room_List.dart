...
Future<void> fetchData() async {
  ...
  Future<void> updateItem(editingItemId) async {
    final String editUrl = "http://localhost:8000/room";
    final response = await http.put(
      Uri.parse('$editUrl/$editingItemId'),
      headers: {"Content-Type": "application/json"},
      body: json.encode(_SelectRoom),
    );
...
class Item {
  ...
  Item({required this.roomNumber, this.roomType, this.capacity,this.price,this.status,this.numberOfBeds,this.id});
